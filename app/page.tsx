    ...
    <Layout>
      <section className="container mx-auto px-6 py-16 flex flex-col md:flex-row items-center gap-12">
        <div className="md:flex-1">
          ...
          <p className="mt-4 text-slate-300 max-w-2xl whitespace-nowrap">Diese Beispielseite zeigt ein modernes, responsives Layout inklusive Impressum (gesetzliche Anbieterkennzeichnung).</p>
        </div>
      </section>
    </Layout>
  );
